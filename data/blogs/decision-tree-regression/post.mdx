...
summary: "See how the Decision Tree Algorithm utilizes a Tree to predict continuous values and learn to implement it using python and scikit learn"
date: '2024-04-09'
images: 
    - '/blogs/decision-tree-regression/thumbnail.jpeg'
authors:
    - Nguyet Pham
tags: 
    - Machine Learning
...
src="/blogs/decision-tree-regression/--dark-flow-1.png"
alt="dark-mode-image"/>
<img
    className="mb-4 block dark:hidden"
    src="/blogs/decision-tree-regression/--light-flow-1.png"
...
<img
className="mb-4 hidden dark:block"
src="/blogs/decision-tree-regression/--dark-flow-2.png"
alt="dark-mode-image"/>
<img
    className="mb-4 block dark:hidden"
    src="/blogs/decision-tree-regression/--light-flow-2.png"
    alt="light-mode-image"
/>
...
<img
className="mb-4 hidden dark:block"
src="/blogs/decision-tree-regression/--dark-flow-3.png"
alt="dark-mode-image"/>
<img
    className="mb-4 block dark:hidden"
    src="/blogs/decision-tree-regression/--light-flow-3.png"
    alt="light-mode-image"
/>
