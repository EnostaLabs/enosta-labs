...
summary: "Learn about polynomial regression, its types and how to implement them using Python."
date: '2024-04-09'
images:
    - '/blogs/polynomial-regression/thumbnail.jpg'
authors:
    - Nguyet Pham
tags: 
    - Machine Learning
...
![Linear Regression](/blogs/polynomial-regression/LinearRegression.webp)
...
![Quadratic Polynomial Regression](/blogs/polynomial-regression/Quadratic.png)
...
![Cubic Polynomial Regression](/blogs/polynomial-regression/Polynomialdeg3.png)
...
![Quartic Polynomial Regression](/blogs/polynomial-regression/Polynomialdeg4.png)
...
![Quadratic Polynomial Regression Graph](/blogs/polynomial-regression/quadpoly.gif)
...
![Cubic Polynomial Regression Graph](/blogs/polynomial-regression/cubepoly.gif)
