...
summary: 'Explore the fundamental algorithm powering machine learning and deep learning.'
date: '2024-04-08'
authors:
    - Nguyet Pham
images: ['/blogs/gradient-descent/thumbnail.jpeg']
tags:
- Gradient Descent
- Machine Learning
draft: false
...
![Differentiable Functions](/blogs/gradient-descent/differentiable_funs_plots.png)

Where as, non-differentiable functions have a step a cusp or a discontinuity:

![Non Differentiable Functions](/blogs/gradient-descent/non-diff-funcs.png)
...
![Gradient Descent @ lr = 0.1](/blogs/gradient-descent/gradient_descent_animation_0.1.gif)
...
![Gradient Descent @ lr = 0.3](/blogs/gradient-descent/gradient_descent_animation_0.3.gif)
...
![Gradient Descent @ lr = 0.9](/blogs/gradient-descent/gradient_descent_animation_0.9.gif)
...
![Gradient Descent @ lr = 1.0](/blogs/gradient-descent/gradient_descent_animation_1.gif)
...
![Gradient Descent @ lr = 0.01](/blogs/gradient-descent/gradient_descent_animation_0.01.gif)
