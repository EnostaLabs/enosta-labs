...
date: '2024-04-09'
images: 
    - '/blogs/decision-tree-classifier/thumbnail.png'
authors:
    - Nguyet Pham
tags: 
    - Machine Learning
...
src="/blogs/decision-tree-classifier/--dark-flow1.png"
alt="dark-mode-image"/>
<img
    className="mb-4 block dark:hidden"
    src="/blogs/decision-tree-classifier/--light-flow1.png"
...
Now let’s look at how this works in practice. We will predict whether a person will play football or not based on given weather conditions.
...
```math
Gini(Hot) = 1 - p(Yes)^2 - p(No)^2 = 1 - (\frac{0}{2})^2 - (\frac{2}{2})^2 = 0
```
