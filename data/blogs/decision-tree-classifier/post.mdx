...
summary: "See how trees work like flowcharts guiding the model in classifying the data!"
date: '2024-04-09'
images: 
    - '/blogs/decision-tree-classifier/thumbnail.jpeg'
authors:
    - Nguyet Pham
tags: 
    - Machine Learning
...
![](/blogs/decision-tree-classifier/--light-flow1.png)
![](/blogs/decision-tree-classifier/--dark-flow1.png)
...
![](/blogs/decision-tree-classifier/--light-flow2.png)
![](/blogs/decision-tree-classifier/--dark-flow2.png)
...
![](/blogs/decision-tree-classifier/--light-flow3.png)
![](/blogs/decision-tree-classifier/--dark-flow3.png)
...
![](/blogs/decision-tree-classifier/--light-flow4.png)
![](/blogs/decision-tree-classifier/--dark-flow4.png)
...
![](/blogs/decision-tree-classifier/--light-flow5.png)
![](/blogs/decision-tree-classifier/--dark-flow5.png)
...
![](/blogs/decision-tree-classifier/--light-flow6.png)
![](/blogs/decision-tree-classifier/--dark-flow6.png)
...
![Confusion Matrix](/blogs/decision-tree-classifier/cm.png)
