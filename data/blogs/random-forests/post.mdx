...
summary: 'This post describes the Random Forest, a method created to solve the overfitting issue of Decision Trees.'
date: '2024-04-09'
authors:
    - Nguyet Pham
images:
    - '/blogs/random-forests/thumbnail.jpeg'
tags: 
    - Machine Learning
    - Regression
    - Classification
...
src="/blogs/random-forests/--dark-tree_1.png"
alt="dark-mode-image"/>
<img
    className="mb-4 block dark:hidden"
    src="/blogs/random-forests/--light-tree_1.png"
...
<img
className="mb-4 hidden dark:block"
src="/blogs/random-forests/--dark-tree_2.png"
alt="dark-mode-image"/>
<img
    className="mb-4 block dark:hidden"
    src="/blogs/random-forests/--light-tree_2.png"
    alt="light-mode-image"
/>
...
<img
className="mb-4 hidden dark:block"
src="/blogs/random-forests/--dark-tree_3.png"
alt="dark-mode-image"/>
<img
    className="mb-4 block dark:hidden"
    src="/blogs/random-forests/--light-tree_3.png"
    alt="light-mode-image"
/>
...
<img
className="mb-4 hidden dark:block"
src="/blogs/random-forests/--dark-forest.png"
alt="dark-mode-image"/>
<img
    className="mb-4 block dark:hidden"
    src="/blogs/random-forests/--light-forest.png"
    alt="light-mode-image"
/>
...
<img
className="mb-4 hidden dark:block"
src="/blogs/random-forests/--dark-forest-pred.png"
alt="dark-mode-image"/>
<img
className="mb-4 block dark:hidden"
src="/blogs/random-forests/--light-forest-pred.png"
alt="light-mode-image"
/>
