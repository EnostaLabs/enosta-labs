...
![](/blogs/random-forests/--light-tree_1.png)
![](/blogs/random-forests/--dark-tree_1.png)

- Tree for Split 2:

![](/blogs/random-forests/--light-tree_2.png)
![](/blogs/random-forests/--dark-tree_2.png)

- Tree for Split 3:

![](/blogs/random-forests/--light-tree_3.png)
![](/blogs/random-forests/--dark-tree_3.png)
...
![](/blogs/random-forests/--light-forest.png)
![](/blogs/random-forests/--dark-forest.png)
...
![](/blogs/random-forests/--light-forest-pred.png)
![](/blogs/random-forests/--dark-forest-pred.png)
