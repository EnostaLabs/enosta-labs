...
title: 'Polkadot'
date: '2019-10-11'
tags: ['blockchain', 'polkadot']
draft: false
summary: 'Proof of Stake (PoS) là một thuật toán đồng thuận cho phép người dùng kiếm được phần thưởng (rewards) từ việc xác thực các khối trên blockchain. Trong PoW, để có thể trở thành validator thì người dùng cần dựa vào sức mạnh phần cứng của mình. Điều này đòi hỏi người dùng đầu tư các phần cứng mining đắt tiền và tiêu thụ lượng điện lớn...'    
images: ["https://cryptologos.cc/logos/polkadot-new-dot-logo.png"]
---
# TABLE OF CONTENT
...
![Nominated Proof of Stake](https://github.com/PhamVuThuNguyet/Blockchain-Documentation/blob/master/imgs/NPoS.png)
...
![NPoS architecture](https://github.com/PhamVuThuNguyet/Blockchain-Documentation/blob/master/imgs/NPoS%202.png)
...
![Fair representation](https://github.com/PhamVuThuNguyet/Blockchain-Documentation/blob/master/imgs/Phragmen.webp)

Ngoài ra chúng ta cần phân bố staked token sao cho cân bằng nhất có thể.

![Security](https://github.com/PhamVuThuNguyet/Blockchain-Documentation/blob/master/imgs/Phragmen%202.webp)
...
![Base58 Scheme](https://github.com/PhamVuThuNguyet/Blockchain-Documentation/blob/master/imgs/base58.png)
...
![Blake2b](https://github.com/PhamVuThuNguyet/Blockchain-Documentation/blob/master/imgs/internal_structure_of_blake2b.png)
...
![Montgomery curve](https://github.com/PhamVuThuNguyet/Blockchain-Documentation/blob/master/imgs/Montgomery%20curve.png)
...
![XCM Tech Stack](https://github.com/PhamVuThuNguyet/Blockchain-Documentation/blob/master/imgs/cross-consensus-tech-stack-e9c1b2ab8b6f6f3f9a78b3a412af0698.png)
...
![Cross-Consensus](https://github.com/PhamVuThuNguyet/Blockchain-Documentation/blob/master/imgs/overview-1-2048x1126.png)
