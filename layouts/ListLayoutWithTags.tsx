...
interface ListLayoutProps {
  posts: CoreContent<Blog>[] | CoreContent<Tutorials>[]
  title: string
  initialDisplayPosts?: CoreContent<Blog>[] | CoreContent<Tutorials>[]
